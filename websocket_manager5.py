...
class WebSocketManager:
    ...
    def start(self):
        ...
        try:
            ...
            print(
                "[WS] Event loop not available yet"
            )
    ...
    def stop_market_data_loop(self):
        self.running = False
    ...
    def broker_ready(self):
        """
        Check whether a saved/access token exists.

        The current broker.py does not have is_connected(),
        so we use the broker's own status() method.
        """
